...
async function handleNewMessagesPlayAgent(client, msg, botName, phoneIndex) {
...
async function getContactDataFromDatabaseByPhone(phoneNumber, idSubstring) {
    try {
        ...
        const contactsRef = db.collection('companies').doc(idSubstring).collection('contacts');
        const doc = await contactsRef.doc(phoneNumber).get();
        ...
        return {
            ...contactData,
            contactName: contactData.contactName || contactData.name || phoneNumber,
            threadID: contactData.threadid || null,
            bot_status: contactData.bot_status || null
        };
    } catch (error) {
        console.error('Error fetching contact data:', error);
        throw error;
...
module.exports = { handleNewMessagesPlayAgent };