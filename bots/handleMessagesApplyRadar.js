...
async function handleNewMessagesApplyRadar(client, msg, botName, phoneIndex) {
            ...
            switch (currentStep) {
                case steps.START:
                    ...
                    for (let i = 0; i < parts.length; i++) {
                        ...
                        const cleanedText = await removeTextInsideDelimiters(part);
                        if (part) {
                            const sentMessage = await client.sendMessage(msg.from, cleanedText);
