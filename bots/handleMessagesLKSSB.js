...
async function createCalendarEvent(summary, description, startDateTime, endDateTime, phoneNumber, contactName,companyName) {
    try {
...
async function handleNewMessagesLKSSB(client, msg, botName, phoneIndex) {
...
async function checkingStatus(threadId, runId) {
    ...
    if(status == 'completed') {
        try{
            ...
            console.log("error from handleNewMessagesLKSSB: "+error)
            throw error;
        }
    }
...
module.exports = { handleNewMessagesLKSSB };