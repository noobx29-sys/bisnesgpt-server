...
async function handleNewMessagesAlist5(client, msg, botName, phoneIndex) {
        ...
        },
        {
            ...
            function: {
                ...
                parameters: {
                    type: "object",
                    properties: {
                        summary: { type: "string", description: `Title of the event include the word "Phone Izzy:"` },
...
module.exports = { handleNewMessagesAlist5 };
