...
var auth = new google.auth.GoogleAuth({
  keyFile: './service_account.json', // Replace with your cßßredentials file path
                    ...
                    for (let i = 0; i < parts.length; i++) {
                        ...
                        if (part) {
                            ...
                            if (part.includes('get back to you')) {
                                ...
                                var { reportMessage, contactInfo } = await generateSpecialReport(threadID, ghlConfig.assistantId, contactName, extractedNumber);
                            ...
                            if (part.includes('check with the team')) {
                                ...
                                // Generate and send the special report
                                var { reportMessage, contactInfo } = await generateSpecialReport2(threadID, ghlConfig.assistantId, contactName, extractedNumber);
                                var sentMessage2 = await client.sendMessage('120363325228671809@g.us', reportMessage)
                                await addMessagetoFirebase(sentMessage2,idSubstring,'+120363325228671809')
                                await addtagbookedFirebase(extractedNumber, 'stop bot', idSubstring);
                            }
...
Date : ${currentDate}
1) Name: ${contactName}
2) Phone Number: ${extractedNumber}
