...
async function initializeBot() {
  const companyId = "wellness_unlimited";
  ...
  try {
    const response = await axios.post(
      ...
      {
        name: "ST Wong",
        companyName: "Wellness Unlimited Group Pte Ltd",
        phoneNumber: "+65 8921 9276",
        email: "Stwong@wellnessunlimited.com.sg",
        password: "123456",
        plan: "premium", // or "blaster", "free", etc.
        country: "Singapore"
      }
    );
